...
export default function SelectedEvent(props) {
  ...
  if(specificEvent && specificEvent.RoomFloorplan && specificEvent.VenueFloorplan){
    roomFloorplan = data.allFile.edges.filter(edges => edges.node.relativePath === specificEvent.RoomFloorplan)
    venueFloorplan = data.allFile.edges.filter(edges => edges.node.relativePath === specificEvent.VenueFloorplan)
  }
      ...
      <CardContent>
          ...
          return (
            ...
            <Typography variant="h6" component="div">
              {specificEvent ? specificEvent.location : null} {strings ? strings.floorplan : null}
            </Typography>
