  ...
  const { t, i18n } = useTranslation();
    ...
    return (
      ...
      {!matches ?
            ...
            <Grid container spacing={5} alignItems="flex-start" justifyContent="center" mt={5} mr={5} ml={5} mb={5}>
            <Grid item xs={4}>
      ...
      :
       ...
       <Box sx={{ width: '100%', height: '100vh', bgcolor: 'white', marginTop: '40px', paddingTop: '30px'  ,marginBottom: '100px'}}>
       <Grid container justifyContent="center" alignItems="center" sx={{ flexGrow: 5, display: 'inline'}}>
             <Stack justifyContent="center" spacing="10px" mb = {7} xs = {10} sx={{display: 'inline', marginBottom: '90px'}}>              
               <Card sx={{ maxWidth: '98%' }}>
               <CardHeader
                 title={t("venue_name")}
                 subheader={t("venue_address")}
